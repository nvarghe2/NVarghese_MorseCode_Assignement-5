 ...
 * CLASS : CMSC204
 * ASSIGNMENT 5
 * DESCRIPTION : A generic linked binary tree which 
 * 				 inherits from the LinkedConverterTreeInterface.  
 * 				 The class uses an external generic TreeNode 
 * 				 class parameterized as a String
 * INSTRUCTOR : Dr.Kuijt
