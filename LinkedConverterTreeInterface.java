 ...
 * CLASS : CMSC204
 * ASSIGNMENT 5
 * DESCRIPTION : Linked Converter Tree INTERFACE
 * INSTRUCTOR : Dr.Kuijt
...
public interface LinkedConverterTreeInterface<T> {
	...
	public LinkedConverterTreeInterface<String> insert(T code, T result);	//added LinkedConverterTreeInterface <String>
